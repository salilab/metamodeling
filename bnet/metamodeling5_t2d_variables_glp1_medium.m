...
%   varaibles.
%   2. The GLP-1 level is set to a medium value to compute its effect on the
%   meta-model.
%
% Return:
...
Experiment1 = importdata('/Users/lipingsun/SynologyDrive/research/Meta-modeling/bnt/Metamodeling-bnet/dataset/meal/140points/meal_exp1_normal2_Gin_dt1_sigmoid.dat');
DGexp = Experiment1(:,2); % Rate of change in glucose intake, mM
Gintakeexp = Experiment1(:,3); % Glucose intake, mM

Metafile = csvread('/Users/lipingsun/SynologyDrive/research/Meta-modeling/bnt/Metamodeling-bnet/bnet/meta_meal_t2d_glp1_medium.txt',1,0);
...
for measure = 1:500
    ...
    evidence{nodes_map('GLP1a.obs'),measure} = 5; 
    evidence{nodes_map('cons.obs'),measure} = 5; 
end
...
writetable(T, 'meta_meal_t2d_variables_glp1_medium.txt');
...
% Write data to text file
writetable(T1, 'meta_spt_t2d_variables_glp1_medium.txt');
...
% Write data to text file
writetable(T2, 'meta_network_t2d_variables_glp1_medium.txt');
