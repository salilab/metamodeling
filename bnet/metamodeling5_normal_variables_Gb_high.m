...
%   varaibles.
% Input:
%   2. The input value of Gb is set to 6 instead of 5.111 to exam its
%   effect on the meta-model.
% 
% Return:
...
Gb_Meal = 6; % Basal plasma glucose level, mM
...
for measure = 1:500
    ...
    meal_evidence{meal_nodes_map('Scell.ref'),measure} = Scell;
...
writetable(T, 'meta_meal_normal_variables_highGb.txt');
...
% Write data to text file
writetable(T1, 'meta_spt_normal_variables_highGb.txt');
...
% Write data to text file
writetable(T2, 'meta_network_normal_variables_highGb.txt');
