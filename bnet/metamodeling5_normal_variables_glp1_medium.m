...
Metafile = csvread('/Users/lipingsun/SynologyDrive/research/Meta-modeling/bnt/Metamodeling-bnet/bnet/meta_meal_normal_glp1_high.txt',1,0);
...
writetable(T, 'meta_meal_normal_variables_glp1_medium.txt');
...
% Write data to text file
writetable(T1, 'meta_spt_normal_variables_glp1_medium.txt');
...
% Write data to text file
writetable(T2, 'meta_network_normal_variables_glp1_medium.txt');
