...
%   2. The GLP-1 level is set to a medium value to compute its effect on the meta-model
% 
% Return:
...
for measure = 1:420
    ...
    evidence{nodes_map('GLP1.obs'),measure} = GLP1_Network*10; 
    ...
    network_evidence{network_nodes_map('GLP1.obs'),measure} = GLP1_Network*10;
