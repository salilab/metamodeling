...
%   2. The GLP-1 level is set to a high value to compute its effect on the meta-model
% 
% Return:
...
for measure = 1:420
    ...
    evidence{nodes_map('GLP1.obs'),measure} = GLP1_Network*20; 
    ...
    network_evidence{network_nodes_map('GLP1.obs'),measure} = GLP1_Network*20;
...
writetable(T, 'meta_meal_normal_glp1_high.txt');
...
% Write data to text file
writetable(T, 'meta_spt_normal_glp1_high.txt');
...
% Write data to text file
writetable(T, 'meta_network_normal_glp1_high.txt');
