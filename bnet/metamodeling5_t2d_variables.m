...
Metafile = csvread('/Users/lipingsun/SynologyDrive/research/Meta-modeling/bnt/Metamodeling-bnet/bnet/meta_meal_t2d.txt',1,0);
...
writetable(T, 'meta_meal_t2d_variables.txt');
...
% Write data to text file
writetable(T1, 'meta_spt_t2d_variables.txt');
...
% Write data to text file
writetable(T2, 'meta_network_t2d_variables.txt');
