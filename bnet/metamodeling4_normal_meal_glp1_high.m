...
for measure = 1:420
    ...
    glp1r_evidence{glp1r_nodes_map('GLP1a.obs'),measure} = 10; % evidence at time slice 2
    glp1r_evidence{glp1r_nodes_map('cons.obs'),measure} = 10; % evidence at time slice 2
end
