...
for measure = 1:500
    ...
    %meal_evidence{meal_nodes_map('DGintake.obs'),measure} = 0; % evidence at time slice 2
...
writetable(T, 'meta_meal_normal_variables.txt');
...
% Write data to text file
writetable(T1, 'meta_spt_normal_variables.txt');
...
% Write data to text file
writetable(T2, 'meta_network_normal_variables.txt');
