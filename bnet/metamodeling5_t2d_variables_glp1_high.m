...
%   varaibles.
%   2. The GLP-1 level is set to a high value to compute its effect on the
%   meta-model.
% 
% Return:
...
Metafile = csvread('/Users/lipingsun/SynologyDrive/research/Meta-modeling/bnt/Metamodeling-bnet/bnet/meta_meal_t2d_glp1_high.txt',1,0);
...
for measure = 1:500
    ...
    evidence{nodes_map('GLP1a.obs'),measure} = 10;
    evidence{nodes_map('cons.obs'),measure} = 10;
end
...
writetable(T, 'meta_meal_t2d_variables_glp1_high.txt');
...
% Write data to text file
writetable(T1, 'meta_spt_t2d_variables_glp1_high.txt');
...
% Write data to text file
writetable(T2, 'meta_network_t2d_variables_glp1_high.txt');
