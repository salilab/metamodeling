...
function [dbn_factory]= make_spt_dbn_factory(Gin_SPT, S_SPT, k_SPT, Nisg_SPT, Npatch_SPT, Ninsulin_SPT, I_SPT)
    ...
    node_names=  { 'lambda.SPT','Gin.SPT','Gin.ref','Gin.obs' 'k.SPT', 'Npatch.SPT' ,...
        'Nisg.SPT', 'Disg.SPT', 'Ninsulin.SPT','Rpbc.SPT', 'S.SPT', 'I.SPT', 'Scell.ref', 'Scell.obs'};
    % Intra - in one time slice
    edges_intra= { 'lambda.SPT','Gin.SPT';'Gin.SPT','Gin.ref';'Gin.ref','Gin.obs';'k.SPT', 'S.SPT';...
        'Npatch.SPT', 'S.SPT'; 'Nisg.SPT', 'S.SPT'; 'Disg.SPT', 'S.SPT'; 'Ninsulin.SPT', 'S.SPT';...
        'Rpbc.SPT', 'S.SPT';'S.SPT', 'Scell.ref'; 'Scell.ref', 'Scell.obs'};
    ...
    CPDFactories{end+1} = ...         
        ...
        {'mean', Gin_SPT, 'cov', 1E-4, 'weights', 0.0});
    ...
    CPDFactories{end+1} = ...
        ...
        {'mean', 0.0,'cov', 1E-4,   'weights', 1.0} ); % E= [1.0*Iref(t)]
    ...
    weights_S1_map_T0('S.SPT')= 0.01; % weightA
    weights_S1_map_T0('Gin.SPT')= 1000; % weightB
    weights_S1_map_T1('k.SPT')= 5; % weightC
    weights_S1_map_T1('Npatch.SPT')= 5; % weightD
    weights_S1_map_T1('Nisg.SPT')= 5; % weightE
    weights_S1_map_T1('Ninsulin.SPT')= 5; % weightE
    weights_S1_map_T1('Disg.SPT')= 1E-5; % weightF
    weights_S1_map_T1('Rpbc.SPT')= -10; % weightF
    CPDFactories{end+1} = ...         
