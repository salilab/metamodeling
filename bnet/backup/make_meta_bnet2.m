...
function [meta_dbn, nodes_map]=make_meta_bnet2(Gex_Meal, Y_Meal, alpha_Meal,beta_Meal, K_Meal, dt_Meal, DGex_Meal, Gb_Meal, Sb_Meal, ...
    Gin_SPT, S_SPT, k_SPT, Nisg_SPT, Npatch_SPT, Ninsulin_SPT)
    ...
    [spt_dbn_factory]= ...
        make_spt_dbn_factory(Gin_SPT, S_SPT, k_SPT, Nisg_SPT, Npatch_SPT, Ninsulin_SPT);
