...
function [dbn_factory]= make_network_dbn_factory(Gin_Network, PFK_Network, ATP_Network, GLP1_Network, GLP1R_Network, cAMP_Network, Ca_Network, S_Network, I_Network)
    node_names=  {'Gin.Network','Gin.ref','ATP.Network','GLP1.Network','GLP1.ref','GLP1.obs','GLP1R.Network','GLP1R.ref','cAMP.Network','Ca.Network',...
        'S.Network','I.Network','Scell.ref'}; 
    n= length(node_names);
    % Intra - in one time slice
    edges_intra= {'Gin.ref','Gin.Network';'GLP1.Network','GLP1.ref';'GLP1.ref','GLP1.obs';'GLP1R.ref','GLP1R.Network';...
       'S.Network','Scell.ref'};
    ...
    CPDFactories{end+1}=  ...
        ...
        {'mean', 0, 'cov', 1E-18,   'weights', 1.0}); % GLP1
    CPDFactories{end+1}=  ...
