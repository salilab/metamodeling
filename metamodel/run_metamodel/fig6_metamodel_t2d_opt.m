...
% ---------------------------------
% postprandial model
Json_postprandial = jsondecode(fileread(['../data/surrogate/postprandial_t2d_s1.json']));
...
% meta model
Json_meta = jsondecode(fileread(['../data/metamodel/meta_t2d_fig6_opt.json']));
...
fn = ['../Output/metamodel_t2d_opt.csv'];
fname = sprintf(fn);
writetable(T, fname);
