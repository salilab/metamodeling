...
% To generate a conditional gaussian model
function [dbn_factory]= make_pancreas_dbn_nocouple_wDGd(Scell_mean_pancreas, Scell_cov_pancreas, Sislet_mean_pancreas, ...
                                          Sislet_cov_pancreas, Spancreas_mean_pancreas, Spancreas_cov_pancreas, ...
                                          cov_scale_pancreas, Nc_pancreas, Ni_pancreas);
    
    node_names=  {'Scell.C','Scell.pancreas','Sis.pancreas','Spa.pancreas','Spa.C','Scell.obs'}; 
    n= length(node_names);
    
    % Intra - in one time slice
    edges_intra= {'Scell.C','Scell.pancreas';'Scell.pancreas','Sis.pancreas';'Sis.pancreas','Spa.pancreas';'Spa.pancreas','Spa.C';'Scell.pancreas','Scell.obs'};
    ...
    CPDFactories{end+1}=  ...
        ...
        {'mean', 0.0,   'cov', Scell_cov_pancreas*cov_scale_pancreas, 'weights', 1.0} );
