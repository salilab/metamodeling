...
% To generate a conditional gaussian model
function [dbn_factory]= make_exocytosis_dbn(G_mean_exocytosis, kt_mean_exocytosis, Npatch_mean_exocytosis,...
    ...
    node_names=  {'Gcell.C','G.exocytosis', 'kt.exocytosis', 'Npatch.exocytosis','Nvesicle.exocytosis',...
                  ...
                  'S.exocytosis', 'Scell.C', 'Scell.obs', 'ScellVE.obs'};
...
%     CPDFactories{end+1} = ...         
%         CPDFactory('Gaussian_CPD', 'G.exocytosis', 0, ...
%         {'mean', 0.0, 'cov', G_VE_cov, 'weights', G_VE_weight}); % G = Gcell.C

    CPDFactories{end+1}=  ...
        CPDFactory('Gaussian_CPD', 'ScellVE.obs', 0, ...
        {'mean', 0.0,   'cov', cov_scale_exocytosis, 'weights', 1.0} ); 
    ...
    CPDFactories{end+1} = ...         
        ...
        {'mean', S_mean_exocytosis, 'cov', S_cov_exocytosis}, weights_S0_map_T0, weights_S0_map_T1); % S
    
    CPDFactories{end+1} = ...
        CPDFactory('Gaussian_CPD', 'Scell.C', 0, ...
        { 'mean', 0.0,'cov', S_cov_exocytosis*cov_scale_exocytosis, 'weights', [S_ve_weight, S_cell_obs_weight]} ); % Scell.C = S
       
%     CPDFactories{end+1} = ...
%         CPDFactory('Gaussian_CPD', 'Scell.C', 0, ...
%         { 'mean', 0.0,'cov', S_cov_exocytosis*cov_scale_exocytosis, 'weights', 1.0} );
    
    CPDFactories{end+1} = ...
        CPDFactory('Gaussian_CPD', 'Scell.obs', 0, ...
        { 'mean', S_cell_obs_mean,'cov', S_cell_obs_cov} ); % Scell.obs = Scell.C
    
%     CPDFactories{end+1} = ...
%         CPDFactory('Gaussian_CPD', 'Sobs.exocytosis', 0, ...
%         { 'mean', 0.0, 'cov', 1e-20, 'weights', 1.0} ); % Scell.C = S
