...
function [meta_dbn, nodes_map]=make_meta_dbn3_datamodel(DGd_mean_postprandial, DGd_cov_postprandial, Gb_mean_postprandial,...
                                              ...
                                              Gcell_mean_data, Gcell_cov_data, ...
                                                Gcell_mean_obs, Gcell_cov_obs, ...
    ...
    [datamodel_dbn_factory]= make_dbn_datamodel(Gcell_mean_data, Gcell_cov_data, ...
                                                Gcell_mean_obs, Gcell_cov_obs, ...
                                                G_cov_data, cov_scale_data);
                                              
    % make DBNs to generate meta- DBN
    meta_dbn_factory= ...
        merge_dbn_factories(postprandial_dbn_factory, pancreas_dbn_factory, exocytosis_dbn_factory, datamodel_dbn_factory);
    ...
    weights_Gcell0_map_T0('Gcell.data')= G_cell_data_weight;
