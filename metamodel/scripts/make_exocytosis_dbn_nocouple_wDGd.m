...
% To generate a conditional gaussian model
function [dbn_factory]= make_exocytosis_dbn_nocouple_wDGd(G_mean_exocytosis, kt_mean_exocytosis, Npatch_mean_exocytosis,...
    ...
    node_names=  {'Gcell.C','G.exocytosis', 'kt.exocytosis', 'Npatch.exocytosis','Nvesicle.exocytosis',...
                  ...
                  'S.exocytosis', 'Scell.C', 'Scell.obs', 'Gcell.obs'};
...
%                    'S.exocytosis','Scell.C'};
    ...
    CPDFactories{end+1} = ...         
        ...
        {'mean', 0.0, 'cov', G_cov_exocytosis*cov_scale_exocytosis, 'weights', 1.0}); 
