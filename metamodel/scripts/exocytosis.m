...
[exocytosis_dbn_factory]= make_exocytosis_dbn_nocouple(Json_exocytosis.DataInput.G_mean_exocytosis, Json_exocytosis.DataInput.kt_mean_exocytosis, Json_exocytosis.DataInput.Npatch_mean_exocytosis,...
...
% Scell_C = importdata(Json_exocytosis.EvidenceInput.Evidence_Scell);
% for measure = 1:Json_exocytosis.DataInput.T
%    evidence{nodes_map('Scell.C'), measure} = Scell_C(measure);
% end
% Gcell_C = importdata(Json_exocytosis.EvidenceInput.Evidence_G);
% for measure = 1:Json_exocytosis.DataInput.T
%    evidence{nodes_map('Gcell.C'),measure} = Gcell_C(measure);
% end
...
writetable(T, '../Output/exocytosis_prior_wDGd.csv');
