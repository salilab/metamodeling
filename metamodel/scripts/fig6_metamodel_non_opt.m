...
% ---------------------------------
% postprandial model
Json_postprandial = jsondecode(fileread(['../data/surrogate/postprandial_normal_s2.json']));
...
% meta model
Json_meta = jsondecode(fileread(['../data/metamodel/meta_normal_fig6_non_opt.json']));
...
fn = ['../Output/metamodel_normal_non_opt.csv'];
fname = sprintf(fn);
writetable(T, fname);
