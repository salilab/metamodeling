    ...
    for n = 4
        ...
        for j = 5
            ...
            for m = 1
                ...
                dbn_engine = gibbs_sampling_inf_engine(dbn);
                disp(dbn);
                disp(nodes_map);
                ...
                % fn = ['../Output/fig3_full_time_CPDs_v2/metamodel_normal_full_time_obs_coupler_test_obs_mean_new_PR_' num2str(S_ve_weight) '_' num2str(G_pr_weight) '_' num2str(G_c_weight) '_' num2str(S_pa_weight) '.csv'];
                fn = ['../Output/metamodel_normal_full_time_noobs_coupler_test_obs_mean_new_PR_' num2str(S_ve_weight) '_' num2str(G_pr_weight) '_' num2str(G_c_weight) '_' num2str(S_pa_weight) '.csv'];
                fname = sprintf(fn);
                writetable(T, fname);
