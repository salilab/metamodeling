...
% To generate a conditional gaussian model
function [dbn_factory]= make_pancreas_dbn_nocouple(Scell_mean_pancreas, Scell_cov_pancreas, Sislet_mean_pancreas, ...
    ...
    edges_intra= {'Scell.C','Scell.pancreas';'Scell.pancreas','Sis.pancreas';'Sis.pancreas','Spa.pancreas';'Spa.pancreas','Spa.C'};
...
%        {'mean',  0.0, 'cov', Spancreas_cov_pancreas*cov_scale_pancreas, 'weights', 1.0} ); % 
