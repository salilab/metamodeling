...
function [dbn_factory]= make_postprandial_dbn_datamodel(DGd_mean_postprandial, DGd_cov_postprandial, Gb_mean_postprandial,...
    ...
    node_names = {'DGd.postprandial','DGd.C','DGd.obs','G.postprandial','G.C',...
                  ...
                  'Sb.postprandial','S.postprandial','I.postprandial','Gcell.obs','G.obs','Gb.obs'}; 
    ...
    edges_intra= {'DGd.postprandial','DGd.C';'DGd.C','DGd.obs';'Gb.postprandial','DG.postprandial';...
                  ...
                  'Gcell.obs','Gcell.C'; 'G.obs', 'G.C';...
                  'G.postprandial', 'Gb.obs';
...
%     
    ...
    CPDFactories{end+1}=  ...
     ...
     CPDFactories{end+1}=  ...
        CPDFactory('Gaussian_CPD', 'Gb.obs', 0, ...
         {'mean', 0.0,   'cov', G_cov_postprandial, 'weights', 1.0} );
