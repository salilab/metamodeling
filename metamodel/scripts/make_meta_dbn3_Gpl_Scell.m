...
function [meta_dbn, nodes_map]=make_meta_dbn3_Gpl_Scell(DGd_mean_postprandial, DGd_cov_postprandial, Gb_mean_postprandial,...
                                              ...
                                              S_cell_obs_weight, G_obs_weight, G_cell_obs_weight, S_pa_obs_weight, G_pl_cov, S_cell_cov, ...
    ...
    [exocytosis_dbn_factory]= make_exocytosis_dbn_scell(G_mean_exocytosis, kt_mean_exocytosis, Npatch_mean_exocytosis,...
                                                  Nvesicle_mean_exocytosis, Ninsulin_mean_exocytosis, Rcell_mean_exocytosis,...
                                                  Dvesicle_mean_exocytosis, S_mean_exocytosis, G_cov_exocytosis,...
                                                  kt_cov_exocytosis, Npatch_cov_exocytosis, Nvesicle_cov_exocytosis, ...
                                                  Ninsulin_cov_exocytosis, Rcell_cov_exocytosis,Dvesicle_cov_exocytosis, ...
                                                  ...
                                                  S_cell_obs_mean, S_cell_obs_cov, S_cell_cov);                                     
                                          
    [postprandial_dbn_factory]= make_postprandial_dbn_pl(DGd_mean_postprandial, DGd_cov_postprandial, Gb_mean_postprandial,...
                                              Gb_cov_postprandial, G_mean_postprandial, G_cov_postprandial,...
                                              DG_mean_postprandial, DG_cov_postprandial, Y_mean_postprandial,...
                                              Y_cov_postprandial, S_mean_postprandial, S_cov_postprandial,...
                                              I_mean_postprandial, I_cov_postprandial, Sb_mean_postprandial,...
    ...
    CPDFactory_Scell_obs = ...
        CPDFactory('Gaussian_CPD', 'Scell.C', 0, {'mean', 0.0, 'cov', S_cell_cov}, ...
    ...
    CPDFactory_G_obs =  ...
       CPDFactory('Gaussian_CPD', 'G.C', 0, {'mean', 0.0,'cov', G_pl_cov}, ...
       weights_G0_map_T0, weights_G0_map_T1 ); % Gcell.obs = 1.0 * Gcell.C 1e-4 p(Gpl_C|Gpl_obs, G^pr)
    ...
    CPDFactory_Gcell_obs = ...
        ...
        weights_Gcell0_map_T0, weights_Gcell0_map_T1); % Gcell.C = 0.5 * G.C 1e-4 p(Gcell_C|Gpl_C, Gcell_obs)
    ...
    CPDFactory_Spa_obs = ...
        CPDFactory('Gaussian_CPD', 'Spa.C', 0, {'mean', 0.0, 'cov', Spancreas_cov_pancreas*cov_scale_pancreas}, ...
        weights_Spa0_map_T0, weights_Spa0_map_T1); % 1e-4
