...
function [bnet, nodes_map]= make_ode_bnet(Gm, Im)
    ...
    bnet.CPD{5} = gaussian_CPD(bnet, nodes_map('Gref'),   'mean', Gm(1), 'cov', 0.1);
    bnet.CPD{6} = gaussian_CPD(bnet, nodes_map('Gexp'), 'mean', Gm(1), 'cov', 0.1);
    
    bnet.CPD{7} = gaussian_CPD(bnet, nodes_map('I'),   'mean', Im(1), 'cov', 5);
    bnet.CPD{8} = gaussian_CPD(bnet, nodes_map('Iref'),   'mean', Im(1), 'cov', 5);
    bnet.CPD{9} = gaussian_CPD(bnet, nodes_map('Iexp'), 'mean', Im(1), 'cov', 5);
