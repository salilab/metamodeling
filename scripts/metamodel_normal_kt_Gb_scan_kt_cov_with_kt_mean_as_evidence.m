...
kt_VE_mean_min_ndx = (length(Gb_kt_mu_input(:,2))+1)/2;
kt_VE_mean_max_ndx = (length(Gb_kt_mu_input(:,2))+1)/2;
kt_VE_cov_min_ndx = 1;
kt_VE_cov_max_ndx = length(Gb_kt_mu_input(:,2));
...
for i = kt_VE_mean_min_ndx:kt_VE_mean_max_ndx
    ...
    for j = kt_VE_cov_min_ndx:kt_VE_cov_max_ndx
        ...
        f1 = sprintf(OUTPUT_PATH+ 'metamodel_scan_input_kt_cov_output_Gb_with_kt_mean_as_evidence.csv', i,j);
