...
for GLP1a_evidence = [0 Json_GLP1R.EvidenceInput.GLP1a1 ...
                      Json_GLP1R.EvidenceInput.GLP1a2 Json_GLP1R.EvidenceInput.GLP1a3]
    ...
    for measure = 1:Json_postprandial.DataInput.T
        ...
        evidence{nodes_map('GLP1a.obs'),measure} = GLP1a_evidence; 
    ...
    fname = sprintf('../results/metamodel_t2d_incretin_%d.csv', GLP1a_evidence);
    writetable(T, fname);
end