...
%    evidence{nodes_map('DGintake.ref'),measure} = 0;
%end
...
for node_name = ["Gex.ref" "Gin.ref" "Scell.ref" "GLP1R.ref" ...
         "Gex.postprandial" "S.postprandial" "Spancreas.pancreas" "Scell.pancreas" "Gb.postprandial" ...
         ...
         "Ca.signaling" "S.signaling" "DGintake.postprandial" ...
         "GLP1R.signaling" "GLP1R.ref"]
    node_values = {};
...
fname = sprintf('../results/metamodel_normal.csv');
writetable(T, fname);
