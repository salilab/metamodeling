...
[signaling_dbn_factory]= make_signaling_dbn(Json_signaling.DataInput.Gin_mean_signaling, Json_signaling.DataInput.ATP_mean_signaling, Json_signaling.DataInput.GLP1_mean_signaling,...
...
%disp(nodes_map('DGintake.signaling'));
...
writetable(T, '../results/signaling_prior_normal.csv');
