...
# Read data file
with open("k_prior.txt", 'rb') as kfile:
...
ax1.plot((10.2091,10.2091),(0,max(yy)),'k',linestyle=":",linewidth=1)
...
right = left + width
top = bottom + height
ax1.text(0.96*(left+right), 0.96*(bottom+top), 'SPT.k - prior: ',horizontalalignment='right',verticalalignment='center',fontsize=20,fontname="Arial",fontweight="normal",color='k',transform=ax1.transAxes)
ax1.text(0.96*(left+right), 0.88*(bottom+top), '10.21 $\pm$ 0.63',horizontalalignment='right',verticalalignment='center',fontsize=20,fontname="Arial",fontweight="normal",color='k',transform=ax1.transAxes)
...
fig.savefig("plot-spt-k.png",dpi=300)
