...
function [dbn_factory]= make_meal_dbn_factory(G_Model, I_Model, alpha_Model,beta_Model, Gb_Model)
    ...
    edges_inter= { 'G.Meal', 'G.Meal'; 'G_minus_Gb.Meal','I.Meal';'I.Meal', 'I.Meal'; 'Gb.Meal', 'Gb.Meal' }; % BARAK comment: switched G->I and h->I to (G-h)->I
    ...
    CPDFactories{end+1}=  ...
        ...
        {'mean', G_Model - Gb_Model, 'cov', 0.1, 'clamp_mean', 1, 'clamp_cov', 1, 'clamp_weights', 1}, ...
    ...
    CPDFactories{end+1} = ...
       CPDFactory('Gaussian_CPD', 'Gb.Meal', 1, ...
        {'mean', 0.0, 'cov', 0.2,  'weights', 1.0} ); % E[Gb(t+1) ] = 1.0*Gb(t) +- 0.2    

    % CPD for G(t+1)
    CPDFactories{end+1} = ...
        CPDFactory('Gaussian_CPD', 'G.Meal', 1, ...
        {'mean', 0.0, 'cov', 0.1,  'weights', 1.0} ); % E[ G(t+1) ] = 1.0*G(t) +- 0.1
    ...
    weights_I1_map_T0('I.Meal')= 1.0 - INITIAL_ALPHA;
    weights_I1_map_T0('G_minus_Gb.Meal')= INITIAL_ALPHA * INITIAL_BETA;
    CPDFactories{end+1} = ...
