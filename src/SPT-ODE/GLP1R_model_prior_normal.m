...
[glp1r_dbn_factory]= make_glp1r_dbn_factory(0.05*1E-3, 0.008);
...
figure()
yyaxis left;
Gvalues = sample_seq(nodes_map('GLP1.GLP1R'),:);
plot(1:T, Gvalues);
yyaxis right;
Ivalues = sample_seq(nodes_map('cAMP.GLP1R'),:);
plot(1:T, Ivalues);
legend('GLP1.Network','cAMP.Network');  
legend('boxoff');
