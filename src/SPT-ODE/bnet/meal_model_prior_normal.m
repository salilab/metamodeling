...
%K_Meal = 300; % Pancreatic responsivity to the glucose rate of change, pmol/L per mM
...
[meal_dbn_factory]= make_meal_dbn_factory_eq(Gex_Meal, Y_Meal, alpha_Meal,beta_Meal, gamma_Meal, k1_Meal, k2_Meal, K_Meal, dt_Meal_min, Gb_Meal, DGintake_Meal, Sb_Meal, Ib_Meal);
