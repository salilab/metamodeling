...
function [dbn_factory]= make_meal_dbn_factory_eq(Gex_Meal, Y_Meal, alpha_Meal,beta_Meal, gamma_Meal, k1_Meal, k2_Meal, K_Meal, dt_Meal_min, Gb_Meal, DGintake_Meal, Sb_Meal, I_Meal)
    ...
    CPDFactories{end+1}=  ...
        ...
        {'mean', DGintake_Meal,   'cov', 1E-10','clamp_cov', 10e-10} ); % DGintake
    CPDFactories{end+1}=  ...
    ...
    CPDFactories{end+1}=  ...
        ...
        {'mean', Gb_Meal,   'cov', 1E-5} ); % Gb
    CPDFactories{end+1}=  ...
        CPDFactory('Gaussian_CPD', 'Gex.Meal', 0, ...
        {'mean', Gex_Meal, 'cov', 1E-5} ); % Gex 
    ...
    CPDFactories{end+1} = ...
        ...
        {'mean', 0.0,'cov', 1E-5, 'weights', 1.0} ); % Gex.ref = 1.0 * Gex
    CPDFactories{end+1} = ...
        CPDFactory('Gaussian_CPD', 'Gin.ref', 0, ...
        {'mean', 0.0,'cov', 1E-5, 'weights', 0.5}); % Gex.obs = 0.5 * Gex.ref
    CPDFactories{end+1} = ...
        CPDFactory('Gaussian_CPD', 'Y.Meal', 0, ...
        {'mean', Y_Meal, 'cov', 1E-3} ); % Y
    CPDFactories{end+1} = ...
        CPDFactory('Gaussian_CPD', 'Scell.ref', 0, ...
        {'mean', Sb_Meal, 'cov', 1E-3} ); % Scell.ref
    ...
    CPDFactories{end+1} = ...
        ...
        { 'mean', I_Meal,'cov', 1E-5} ); % I
    CPDFactories{end+1} = ...
        CPDFactory('Gaussian_CPD', 'I.ref', 0, ...
        { 'mean', 0.0,'cov', 1E-5,   'weights', 1.0} ); % I.ref = 1.0 * I
    CPDFactories{end+1} = ...
        CPDFactory('Gaussian_CPD', 'I.obs', 0, ...
        { 'mean', 0.0,'cov', 1E-5,   'weights', 1.0} ); % I.obs = 1.0 * I.ref 
    ...
    CPDFactories{end+1} = ...
       CPDFactory('Gaussian_CPD', 'Gb.Meal', 1, ...
        {'mean',0.0,'cov', 1E-5, 'weights', 1.0} ); % Gb(t+1) = 1.0 * Gb(t)    
    % CPD for G(t+1)
    ...
    %weights_S1_map_T1('Scell.Meal')= 0.0;
    CPDFactories{end+1}=  ...
