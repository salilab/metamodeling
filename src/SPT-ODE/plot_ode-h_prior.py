...
# Read data file
with open("h_prior.txt", 'rb') as kfile:
...
ax1.plot((6.4614,6.4614),(0,max(yy)),'k',linestyle=":",linewidth=1)
...
right = left + width
top = bottom + height
ax1.text(0.96*(left+right), 0.96*(bottom+top), 'Meal.h - prior: ',horizontalalignment='right',verticalalignment='center',fontsize=20,fontname="Arial",fontweight="normal",color='k',transform=ax1.transAxes)
ax1.text(0.96*(left+right), 0.88*(bottom+top), '6.46 $\pm$ 0.42',horizontalalignment='right',verticalalignment='center',fontsize=20,fontname="Arial",fontweight="normal",color='k',transform=ax1.transAxes)
...
fig.savefig("plot-ode-h.png",dpi=300)
