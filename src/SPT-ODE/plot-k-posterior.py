...
# Read data file
with open("k_posterior.txt", 'rb') as kfile:
...
#9.023592 sigma 0.109810 +- 0.331376

ax1.plot(xx,yy,'k',linestyle="-",linewidth=2)
ax1.plot((9.023592,9.023592),(0,max(yy)),'k',linestyle=":",linewidth=1)
...
right = left + width
top = bottom + height
ax1.text(0.96*(left+right), 0.96*(bottom+top), 'SPT.k - posterior: ',horizontalalignment='right',verticalalignment='center',fontsize=20,fontname="Arial",fontweight="normal",color='k',transform=ax1.transAxes)
ax1.text(0.96*(left+right), 0.88*(bottom+top), '9.02 $\pm$ 0.33',horizontalalignment='right',verticalalignment='center',fontsize=20,fontname="Arial",fontweight="normal",color='k',transform=ax1.transAxes)
...
fig.savefig("plot_SPT-k-posterior.png",dpi=300)
