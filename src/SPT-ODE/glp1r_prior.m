% Make a DBN for the GLP1 model with the following variables
%
...
time = 1
[ode_dbn_factory]= make_glp1r_dbn_factory(Im1, time);
...
y = sample_seq(nodes_map('GLP1R.cAMP'),:);
nbins = 10;
...
marg = marginal_nodes(dbn_engine, nodes_map('GLP1R.cAMP'),10);
...
evidence{nodes_map('GLP1R.cAMP'),2} = 25.0; 
i=10
disp(i)
marg= marginal_nodes(enter_evidence(dbn_engine, evidence), ...
                     nodes_map('GLP1R.cAMP')+npers, ...
                     i);
