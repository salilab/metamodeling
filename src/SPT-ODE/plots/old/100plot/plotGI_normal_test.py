...
data1 = np.loadtxt("/Users/lipingsun/research/Meta-modeling/bnt/Meta-modeling2/dataset/meal/105points/meal_exp1_normal2.dat")
data2 = np.loadtxt("/Users/lipingsun/research/Meta-modeling/bnt/Meta-modeling2/dataset/meal/105points/meal_exp1_t2b2.dat")
data3 = np.loadtxt("/Users/lipingsun/research/Meta-modeling/bnt/Meta-modeling2/dataset/meal/105points/meal_exp1_normal2_DG.dat")
Gnormal=[]
Gt2b=[]
DG=[]
...
I1=meal_model_normal(Gnormal,DG, 3.33333)
I2=meal_model_t2b(Gt2b,DG, 3.33333)
#sys.exit()
print(I1)
...
ax1.plot(timeslice,Gt2b,linestyle='-',c='r',linewidth=2)

#ax2.plot(timeslice,I1,linestyle='-',c='green',linewidth=2)

Ifit1 = savgol_filter(I1, 125, 15) # window size 51, polynomial order 3
Ifit2 = savgol_filter(I2, 125, 15) # window size 51, polynomial order 3

ax2.plot(timeslice,I1,marker='o',linestyle='none',c='green',markersize=2)
#ax2.plot(timeslice,I2,marker='o',linestyle='none',c='green',markersize=2)

ax2.plot(timeslice[50:],I1[50:],linestyle='-',c='k',linewidth=2)
#ax2.plot(timeslice[100:],I2[100:],linestyle=':',c='r',linewidth=2)
ax2.plot(timeslice[0:50],Ifit1[0:50],linestyle='-',c='k',linewidth=2)
#ax2.plot(timeslice[0:100],Ifit2[0:100],linestyle=':',c='r',linewidth=2)
