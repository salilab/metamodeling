...
Ifit1 = savgol_filter(I, 209, 10) # window size 51, polynomial order 3

ax2.plot(timeslice[100:],I[100:],linestyle=':',c='k',linewidth=2)
ax2.plot(timeslice[0:100],Ifit1[0:100],linestyle=':',c='k',linewidth=2)

ax2.plot(timeslice,I,marker='o',linestyle='none',c='green',markersize=2)
