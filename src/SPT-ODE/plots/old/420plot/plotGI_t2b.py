...
with open("../meal_G-Spo_t2b.txt", 'rb') as kfile:
    next(kfile)
...
ax2.errorbar(timeslice,I, yerr=Istd,marker='o',linestyle='none',markersize=2, fmt='-',capsize=0.2, elinewidth=0.2,linewidth=2,c='r')
...
ax1.text(0.02*(left+right), 0.95*(bottom+top), 'T2B subject',horizontalalignment='left',verticalalignment='center',fontsize=18,fontname="Arial",fontweight="normal",color='k',transform=ax1.transAxes)
...
fig.savefig("meal_GI_t2b.jpg",dpi=400)
