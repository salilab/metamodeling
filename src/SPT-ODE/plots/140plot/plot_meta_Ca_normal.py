...
for i in range(0, len(data)):
    k_prior_mu.append(float(data[i][7])*100000)
    k_prior_sigma.append(float(data[i][8])*100000)
    k_posterior_mu.append(float(data[i][22])*100000)
    k_posterior_sigma.append(float(data[i][23])*100000)
...
k_posterior_sigma2=[]
for i in range(0, len(data)):
    k_prior_mu2.append(float(data2[i][7])*100000)
    k_prior_sigma2.append(float(data2[i][8])*100000)
    k_posterior_mu2.append(float(data2[i][22])*100000)
    k_posterior_sigma2.append(float(data2[i][23])*100000)
...
ax1.set_xlabel('Ca.Network (E-3 mM)',fontname="Arial",fontweight="normal",fontsize="20")
...
ax1.plot((k_posterior_mu[499],k_posterior_mu[499]),(0,max(k_posterior)),'red',linestyle=":",linewidth=1)
...
fig.savefig("meta_netework_Ca_normal.png",dpi=300)
