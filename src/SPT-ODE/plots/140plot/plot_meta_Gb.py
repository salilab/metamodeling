...
ax1.set_xlabel('Gb.Meal (mM)',fontname="Arial",fontweight="normal",fontsize="20")
...
ax1.plot((Gb_posterior_mu2[499],Gb_posterior_mu2[499]),(0,max(Gb_posterior2)),'r',linestyle=":",linewidth=1)
...
right = left + width
top = bottom + height
ax1.text(0.71*(left+right), 0.95*(bottom+top), 'Gb.Meta - Normal',horizontalalignment='left',verticalalignment='center',fontsize=18,fontname="Arial",fontweight="normal",color='k',transform=ax1.transAxes)
ax1.text(0.71*(left+right), 0.88*(bottom+top), 'Gb.Meta - T2D',horizontalalignment='left',verticalalignment='center',fontsize=18,fontname="Arial",fontweight="normal",color='k',transform=ax1.transAxes)
