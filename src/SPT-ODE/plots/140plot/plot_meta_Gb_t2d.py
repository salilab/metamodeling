...
ax1.set_xlabel('G$_b$ (mM)',fontname="Arial",fontweight="normal",fontsize="20")
...
ax1.plot(x,Gb_prior2,'red',linestyle="-",linewidth=2)
ax1.plot(x,Gb_posterior2,'darkorange',linestyle="-",linewidth=2)

ax1.plot((Gb_prior_mu2[499],Gb_prior_mu2[499]),(0,max(Gb_prior2)),'red',linestyle=":",linewidth=1)
ax1.plot((Gb_posterior_mu2[499],Gb_posterior_mu2[499]),(0,max(Gb_posterior2)),'darkorange',linestyle=":",linewidth=1)

ax1.plot((3, 3.6),(2.43, 2.43),linestyle='-',c='k',linewidth=1.5)
ax1.plot((3, 3.6),(2.28, 2.28),linestyle='-',c='blue',linewidth=1.5)
ax1.plot((8.2, 8.8),(2.43, 2.43),linestyle='-',c='red',linewidth=1.5)
ax1.plot((8.2, 8.8),(2.28, 2.28),linestyle='-',c='darkorange',linewidth=1.5)
...
right = left + width
top = bottom + height
ax1.text(0.32*(left+right), 0.96*(bottom+top), 'G$_b$.Meal - Normal',horizontalalignment='left',verticalalignment='center',fontsize=18,fontname="Arial",fontweight="normal",color='k',transform=ax1.transAxes)
ax1.text(0.75*(left+right), 0.96*(bottom+top), 'G$_b$.Meal - T2D',horizontalalignment='left',verticalalignment='center',fontsize=18,fontname="Arial",fontweight="normal",color='k',transform=ax1.transAxes)
