...
function [dbn_factory]= make_spt_dbn_factory(Go, Io, time)
    ...
    edges_inter= { 'SPT.Gisg', 'SPT.Gisg'; 'SPT.Gisg', 'SPT.Ipm'; 'SPT.Ipm', 'SPT.Ipm'; 'SPT.k', 'SPT.k';'SPT.Npatch', 'SPT.Npatch' };
    ...
    eclass2_map('SPT.Npatch')= 'SPT.Npatch.inter';
    ...
    CPDFactories{end+1} = ...
       CPDFactory('Gaussian_CPD', 'SPT.Npatch', 1, ...
        {'mean', 0.0, 'cov', 1e-2,  'weights', 1.0} ); % E[ k(t+1) ] = 1.0*k(t) +-  sqrt(1E-8)    
