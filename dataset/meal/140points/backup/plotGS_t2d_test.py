...
# Plot for heating
ax1.plot(timeslice,Gt2d,linestyle='none',marker='o',markersize=4,markerfacecolor="None",markeredgecolor='chocolate', markeredgewidth=1, alpha=0.6)

ax1.plot(timeslice,Gt2d,linestyle='-',c='brown',linewidth=1.5)

ax2.plot(timeslice,S2,linestyle='none',marker='o',markersize=4,markerfacecolor="None",markeredgecolor='green', markeredgewidth=1, alpha=0.6)
...
ax2.plot(timeslice[0:50],Sfit2[0:50],linestyle='-',c='darkgreen',linewidth=1.5)
ax2.plot(timeslice[49:],S2[49:],linestyle='-',c='darkgreen',linewidth=1.5)
...
fig.savefig("meal_GS_test_t2d.png", transparent=True,dpi=400)
