...
# Read data file
with open("h_meta.txt", 'rb') as kfile:
...
ax1.set_xlabel('Meta.h (mM)',fontname="Arial",fontweight="normal",fontsize="20")
...
#5.866040 sigma 0.109962 +- 0.331605

ax1.plot(xx,yy,'k',linestyle="-",linewidth=2)
ax1.plot((5.866040,5.866040),(0,max(yy)),'k',linestyle=":",linewidth=1)
...
right = left + width
top = bottom + height
ax1.text(0.96*(left+right), 0.96*(bottom+top), 'Meta.h - posterior: ',horizontalalignment='right',verticalalignment='center',fontsize=20,fontname="Arial",fontweight="normal",color='k',transform=ax1.transAxes)
ax1.text(0.96*(left+right), 0.88*(bottom+top), '5.87 $\pm$ 0.33',horizontalalignment='right',verticalalignment='center',fontsize=20,fontname="Arial",fontweight="normal",color='k',transform=ax1.transAxes)
...
fig.savefig("plot-ode-h_meta.png",dpi=300)
