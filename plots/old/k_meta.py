...
# Read data file
with open("../normal/k_meta4_posterior1-2.txt", 'rb') as kfile:
    next(kfile)
...
right = left + width
top = bottom + height
ax1.text(0.96*(left+right), 0.96*(bottom+top), 'posterior with no GLP-1R: 10.0 $\pm$ 2.0',horizontalalignment='right',verticalalignment='center',fontsize=20,fontname="Arial",fontweight="normal",color='k',transform=ax1.transAxes)
ax1.text(0.96*(left+right), 0.88*(bottom+top), 'posterior4 with GLP-1R: 11.4 $\pm$ 2.0',horizontalalignment='right',verticalalignment='center',fontsize=20,fontname="Arial",fontweight="normal",color='red',transform=ax1.transAxes)
...
fig.savefig("k_meta4_posterior1-2.png",dpi=300)
