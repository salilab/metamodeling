...
# Read data file
with open("h_posterior.txt", 'rb') as kfile:
...
ax1.set_xlabel('Meal.h (mM)',fontname="Arial",fontweight="normal",fontsize="20")
...
#4.764110 sigma 0.109589 +- 0.331042

ax1.plot(xx,yy,'k',linestyle="-",linewidth=2)
ax1.plot((4.764110,4.764110),(0,max(yy)),'k',linestyle=":",linewidth=1)
...
right = left + width
top = bottom + height
ax1.text(0.96*(left+right), 0.96*(bottom+top), 'Meal.h - posterior: ',horizontalalignment='right',verticalalignment='center',fontsize=20,fontname="Arial",fontweight="normal",color='k',transform=ax1.transAxes)
ax1.text(0.96*(left+right), 0.88*(bottom+top), '4.76 $\pm$ 0.33',horizontalalignment='right',verticalalignment='center',fontsize=20,fontname="Arial",fontweight="normal",color='k',transform=ax1.transAxes)
...
fig.savefig("plot-ode-h_posterior.png",dpi=300)
