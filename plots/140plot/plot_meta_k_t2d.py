...
ax1.plot(x,k_posterior,'blue',linestyle="-",linewidth=2)

ax1.plot((k_prior_mu[499],k_prior_mu[499]),(0,max(k_prior)+0.02),'k',linestyle=":",linewidth=1)
ax1.plot((k_posterior_mu[499],k_posterior_mu[499]),(0,max(k_posterior)),'blue',linestyle=":",linewidth=1)
...
ax1.plot((13, 14),(0.182, 0.182),linestyle='-',c='blue',linewidth=1.5)
ax1.plot((13, 14),(0.172, 0.172),linestyle='-',c='red',linewidth=1.5)
...
ax1.text(0.71*(left+right), 0.91*(bottom+top), 'k.Meta - Normal',horizontalalignment='left',verticalalignment='center',fontsize=18,fontname="Arial",fontweight="normal",color='k',transform=ax1.transAxes)
ax1.text(0.71*(left+right), 0.86*(bottom+top), 'k.Meta - T2D',horizontalalignment='left',verticalalignment='center',fontsize=18,fontname="Arial",fontweight="normal",color='k',transform=ax1.transAxes)
