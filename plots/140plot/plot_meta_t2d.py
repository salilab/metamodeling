...
#ax2.plot(timeslice,meal_I,linestyle='-',c='k',linewidth=1)
...
ax2.plot(timeslice,meta_meal_I,linestyle='-',c='darkgreen',linewidth=1)
...
fig.savefig("meta_meal_t2d.png", transparent=True,dpi=400)
