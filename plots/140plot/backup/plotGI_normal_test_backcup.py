...
def meal_model_normal(G, DG, dt):
    ...
    for i in range(0, len(G)-1):
        ...
        Spo[i+1] = Y[i+1] + 34 + 828 * DG[i]/dt
    return Spo

def meal_model_t2b(G, DG, dt):
    Y=[None]*len(G)
    Y[0] = 0
    Spo=[None]*len(G)
    Spo[0] = 102.5
    for i in range(0, len(G)-1):
        ...
        Spo[i+1] = Y[i+1] + 102.5 + 445.5 * DG[i]/dt
    return Spo

# Read data file

data1 = np.loadtxt("/Users/lipingsun/research/Meta-modeling/bnt/Meta-modeling2/dataset/meal/140points/meal_exp1_normal2.dat")
data2 = np.loadtxt("/Users/lipingsun/research/Meta-modeling/bnt/Meta-modeling2/dataset/meal/140points/meal_exp1_t2b2.dat")
data3 = np.loadtxt("/Users/lipingsun/research/Meta-modeling/bnt/Meta-modeling2/dataset/meal/140points/meal_exp1_normal2_DG.dat")
data4 = np.loadtxt("/Users/lipingsun/research/Meta-modeling/bnt/Meta-modeling2/dataset/meal/140points/meal_exp1_t2b2_DG.dat")
Gnormal=[]
Gt2b=[]
DGnormal=[]
DGt2b=[]
...
I1=meal_model_normal(Gnormal,DGnormal, 3)
I2=meal_model_t2b(Gt2b,DGt2b, 3)
#sys.exit()
print(I1)
...
ax2.set_ylabel('Spo.Meal (pM/min)',fontname="Arial",fontweight="normal",fontsize="20",color='green')
...
#ax2.plot(timeslice,I1,linestyle='-',c='green',linewidth=2)


ax1.plot(timeslice,Gnormal,linestyle='none',marker='o',markersize=4,markerfacecolor="None",markeredgecolor='chocolate', markeredgewidth=1)
ax1.plot(timeslice,Gt2b,linestyle='none',marker='^',markersize=4,markerfacecolor="chocolate",markeredgecolor='chocolate', markeredgewidth=1)

ax1.plot(timeslice,Gnormal,linestyle='-',c='k',linewidth=2)
ax1.plot(timeslice,Gt2b,linestyle='-',c='red',linewidth=2)

ax2.plot(timeslice,I1,linestyle='none',marker='o',markersize=4,markerfacecolor="None",markeredgecolor='green', markeredgewidth=1)
ax2.plot(timeslice,I2,linestyle='none',marker='^',markersize=4,markerfacecolor="green",markeredgecolor='green', markeredgewidth=1)

Ifit1 = savgol_filter(I1, 139, 15) # window size 51, polynomial order 3
Ifit2 = savgol_filter(I2, 139, 15) # window size 51, polynomial order 3

ax2.plot(timeslice[0:50],Ifit1[0:50],linestyle='-',c='k',linewidth=2)
ax2.plot(timeslice[0:50],Ifit2[0:50],linestyle='-',c='red',linewidth=2)
ax2.plot(timeslice[49:],I1[49:],linestyle='-',c='k',linewidth=2)
ax2.plot(timeslice[49:],I2[49:],linestyle='-',c='red',linewidth=2)
