...
right = left + width
top = bottom + height
ax1.text(0.71*(left+right), 0.95*(bottom+top), 'Gb.Meal - Normal',horizontalalignment='left',verticalalignment='center',fontsize=18,fontname="Arial",fontweight="normal",color='k',transform=ax1.transAxes)
