...
# Read data file
with open("../../bnet/meta_meal_normal_variables.txt", 'rb') as kfile:
    next(kfile)
...
ax1.set_xlabel('Gb (mM)',fontname="Arial",fontweight="normal",fontsize="20")
...
print(Gb_prior_mu[499], Gb_prior_sigma[499])
print(Gb_posterior_mu[499], Gb_posterior_sigma[499])

Gb_prior = gaussian(x, Gb_prior_mu[499], Gb_prior_sigma[499])
Gb_posterior = gaussian(x, Gb_posterior_mu[499], Gb_posterior_sigma[499])

Gb_prior2 = gaussian(x, Gb_prior_mu2[499], Gb_prior_sigma2[499])
Gb_posterior2 = gaussian(x, Gb_posterior_mu2[499], Gb_posterior_sigma2[499])

ax1.plot(x,Gb_prior,'k',linestyle="-",linewidth=2)
ax1.plot(x,Gb_posterior,'blue',linestyle="-",linewidth=2)

ax1.plot((Gb_prior_mu[499],Gb_prior_mu[499]),(0,max(Gb_prior)),'k',linestyle=":",linewidth=1)
ax1.plot((Gb_posterior_mu[499],Gb_posterior_mu[499]),(0,max(Gb_posterior)),'blue',linestyle=":",linewidth=1)

ax1.plot(x,Gb_prior2,'brown',linestyle="-",linewidth=2)
ax1.plot(x,Gb_posterior2,'red',linestyle="-",linewidth=2)

ax1.plot((Gb_prior_mu2[499],Gb_prior_mu2[499]),(0,max(Gb_prior2)),'brown',linestyle=":",linewidth=1)
ax1.plot((Gb_posterior_mu2[499],Gb_posterior_mu2[499]),(0,max(Gb_posterior2)),'red',linestyle=":",linewidth=1)

ax1.plot((3, 3.6),(2.43, 2.43),linestyle='-',c='k',linewidth=1.5)
ax1.plot((3, 3.6),(2.28, 2.28),linestyle='-',c='blue',linewidth=1.5)
ax1.plot((8.2, 8.8),(2.43, 2.43),linestyle='-',c='brown',linewidth=1.5)
ax1.plot((8.2, 8.8),(2.28, 2.28),linestyle='-',c='r',linewidth=1.5)
...
right = left + width
top = bottom + height
ax1.text(0.32*(left+right), 0.96*(bottom+top), 'Gb.Meal - Normal',horizontalalignment='left',verticalalignment='center',fontsize=18,fontname="Arial",fontweight="normal",color='k',transform=ax1.transAxes)
ax1.text(0.75*(left+right), 0.96*(bottom+top), 'Gb.Meta - T2D',horizontalalignment='left',verticalalignment='center',fontsize=18,fontname="Arial",fontweight="normal",color='k',transform=ax1.transAxes)
ax1.text(0.32*(left+right), 0.91*(bottom+top), 'Gb.Meta - Normal',horizontalalignment='left',verticalalignment='center',fontsize=18,fontname="Arial",fontweight="normal",color='k',transform=ax1.transAxes)
ax1.text(0.75*(left+right), 0.91*(bottom+top), 'Gb.Meta - T2D',horizontalalignment='left',verticalalignment='center',fontsize=18,fontname="Arial",fontweight="normal",color='k',transform=ax1.transAxes)
