...
for tick in ax1.yaxis.get_major_ticks():
    tick.label.set_fontsize(20)
    tick.label.set_fontname("Arial")
for axis in ['bottom','left']:ax1.spines[axis].set_linewidth(1)
...
plt.axvspan(3.9, 7.1, color='yellow', alpha=0.2, lw=0)

ax1.plot((3.9,3.9),(0,10),'k',linestyle="-",linewidth=0.5)
ax1.plot((7.1,7.1),(0,10),'k',linestyle="-",linewidth=0.5)
#10.2091+-0.6346

x=np.linspace(0, 20, 1000)

print(Gb_prior_mu[200], Gb_prior_sigma[200])
print(Gb_posterior_mu[200], Gb_posterior_sigma[200])

Gb_prior = gaussian(x, Gb_prior_mu[200], Gb_prior_sigma[200])
Gb_posterior = gaussian(x, Gb_posterior_mu[200], Gb_posterior_sigma[200])

Gb_prior2 = gaussian(x, Gb_prior_mu2[200], Gb_prior_sigma2[200])
Gb_posterior2 = gaussian(x, Gb_posterior_mu2[200], Gb_posterior_sigma2[200])

#ax1.plot(x,Gb_prior,'k',linestyle="-",linewidth=2)
ax1.plot(x,Gb_posterior,'r',linestyle="-",linewidth=2)


#ax1.plot((Gb_prior_mu[200],Gb_prior_mu[200]),(0,max(Gb_prior)),'k',linestyle=":",linewidth=1)
ax1.plot((Gb_posterior_mu[200],Gb_posterior_mu[200]),(0,max(Gb_posterior)),'r',linestyle=":",linewidth=1)

#ax1.plot(x,Gb_prior2,'brown',linestyle="-",linewidth=2)
#ax1.plot(x,Gb_posterior2,'r',linestyle="-",linewidth=2)

#ax1.plot((Gb_prior_mu2[200],Gb_prior_mu2[200]),(0,max(Gb_prior2)),'brown',linestyle=":",linewidth=1)
#ax1.plot((Gb_posterior_mu2[200],Gb_posterior_mu2[200]),(0,max(Gb_posterior2)),'r',linestyle=":",linewidth=1)

#ax1.plot((7.8, 8.4),(2.4, 2.4),linestyle='-',c='blue',linewidth=1.5)
#ax1.plot((7.8, 8.4),(2.2, 2.2),linestyle='-',c='r',linewidth=1.5)
...
right = left + width
top = bottom + height
ax1.text(0.58*(left+right), 0.98*(bottom+top), 'Measured G$_{basal}$ \nthroughout the day',horizontalalignment='center',verticalalignment='top',fontsize=18,fontname="Arial",fontweight="normal",color='k',transform=ax1.transAxes)
...
fig.savefig("meta_Gb.png",dpi=300)
