...
# Read data file
with open("t2d_meal_glucose.dat", 'rb') as kfile:
    d1 = list(csv.reader(kfile))
    kfile.close()
    
with open("t2d_meal_glucose_10ug_ex-4.dat", 'rb') as kfile:
    d2 = list(csv.reader(kfile))
    kfile.close()

with open("t2d_meal_insulin.dat", 'rb') as kfile:
    d3 = list(csv.reader(kfile))
    kfile.close()

with open("t2d_meal_insulin_10ug_ex-4.dat", 'rb') as kfile:
...
for i in range(0, len(d1)):
    time1.append(float(d1[i][0]))
    g1.append(float(d1[i][1]))
    
time2=[]
g2=[]
for i in range(0, len(d2)):
    time2.append(float(d2[i][0]))
...
p=patches.FancyArrowPatch((50,145),(50,300),arrowstyle='->',linewidth=2,connectionstyle='arc3',mutation_scale=20,alpha=1)
p.set_edgecolor('k')
p.set_facecolor('k')
p.set_zorder(10)
ax2.add_patch(p)

p=patches.FancyArrowPatch((170,160),(170,-45),arrowstyle='->',linewidth=2,connectionstyle='arc3',mutation_scale=20,alpha=1)
p.set_edgecolor('k')
p.set_facecolor('k')
p.set_zorder(10)
ax2.add_patch(p)
...
fig.savefig("clinical_t2d_glp1.png", transparent=True,dpi=400)
