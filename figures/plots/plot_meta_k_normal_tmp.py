...
ax1.plot(x-1.5,k_posterior*0.9,'green',linestyle="-",linewidth=2)
...
ax1.plot((15, 16),(0.164, 0.164),linestyle='-',c='green',linewidth=1.5)
...
ax1.text(0.82*(left+right), 0.81*(bottom+top), 'k.Meta - KEGG',horizontalalignment='left',verticalalignment='center',fontsize=18,fontname="Arial",fontweight="normal",color='k',transform=ax1.transAxes)
...
fig.savefig("meta_spt_k_normal_tmp.png",dpi=300)
