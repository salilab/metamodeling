...
with open("../../bnet/meta_spt_t2d_variables_glp1_medium.txt", 'rb') as kfile:
    next(kfile)
    spt1 = list(csv.reader(kfile))
    kfile.close()
    
with open("../../bnet/meta_spt_t2d_variables_glp1_high.txt", 'rb') as kfile:
    next(kfile)
...
fig.savefig("meta_spt_k_t2d_glp1.png",dpi=300)
