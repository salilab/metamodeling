...
print(Gb_prior_mu[300], Gb_prior_sigma[300])
print(Gb_posterior_mu[300], Gb_posterior_sigma[300])

Gb_prior = gaussian(x, Gb_prior_mu[300], Gb_prior_sigma[300])
Gb_posterior = gaussian(x, Gb_posterior_mu[300], Gb_posterior_sigma[300])

Gb_prior2 = gaussian(x, Gb_prior_mu2[300], Gb_prior_sigma2[300])
Gb_posterior2 = gaussian(x, Gb_posterior_mu2[300], Gb_posterior_sigma2[300])

ax1.plot(x,Gb_prior,'k',linestyle="-",linewidth=2)
ax1.plot(x,Gb_posterior,'r',linestyle="-",linewidth=2)

ax1.plot((Gb_prior_mu[300],Gb_prior_mu[300]),(0,max(Gb_prior)),'k',linestyle=":",linewidth=1)
ax1.plot((Gb_posterior_mu[300],Gb_posterior_mu[300]),(0,max(Gb_posterior)),'r',linestyle=":",linewidth=1)

#ax1.plot(x,Gb_prior2,'brown',linestyle="-",linewidth=2)
#ax1.plot(x,Gb_posterior2,'r',linestyle="-",linewidth=2)

#ax1.plot((Gb_prior_mu2[300],Gb_prior_mu2[300]),(0,max(Gb_prior2)),'brown',linestyle=":",linewidth=1)
#ax1.plot((Gb_posterior_mu2[300],Gb_posterior_mu2[300]),(0,max(Gb_posterior2)),'r',linestyle=":",linewidth=1)
...
fig.savefig("meta_Gb_highGb.png",dpi=300)
