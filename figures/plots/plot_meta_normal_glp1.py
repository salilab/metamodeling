...
with open("../../bnet/meta_meal_normal_glp1_medium.txt", 'rb') as kfile:
    next(kfile)
    meal1 = list(csv.reader(kfile))
    kfile.close()
    
with open("../../bnet/meta_meal_normal_glp1_high.txt", 'rb') as kfile:
    next(kfile)
...
p=patches.FancyArrowPatch((55,270),(55,415),arrowstyle='->',linewidth=2,connectionstyle='arc3',mutation_scale=20,alpha=1)
p.set_edgecolor('k')
p.set_facecolor('k')
p.set_zorder(10)
ax2.add_patch(p)

p=patches.FancyArrowPatch((120,160),(120,50),arrowstyle='->',linewidth=2,connectionstyle='arc3',mutation_scale=20,alpha=1)
p.set_edgecolor('k')
p.set_facecolor('k')
p.set_zorder(10)
ax2.add_patch(p)
...
right = left + width
top = bottom + height
ax1.text(0.35*(left+right), 0.96*(bottom+top), 'Glucose',horizontalalignment='left',verticalalignment='center',fontsize=18,fontname="Arial",fontweight="normal",color='k',transform=ax1.transAxes)
ax1.text(0.71*(left+right), 0.96*(bottom+top), 'Insulin',horizontalalignment='left',verticalalignment='center',fontsize=18,fontname="Arial",fontweight="normal",color='k',transform=ax1.transAxes)
ax1.text(0.35*(left+right), 0.91*(bottom+top), 'Glucose - Glp1+',horizontalalignment='left',verticalalignment='center',fontsize=18,fontname="Arial",fontweight="normal",color='k',transform=ax1.transAxes)
ax1.text(0.71*(left+right), 0.91*(bottom+top), 'Insulin - Glp1+',horizontalalignment='left',verticalalignment='center',fontsize=18,fontname="Arial",fontweight="normal",color='k',transform=ax1.transAxes)
ax1.text(0.35*(left+right), 0.85*(bottom+top), 'Glucose - Glp1++',horizontalalignment='left',verticalalignment='center',fontsize=18,fontname="Arial",fontweight="normal",color='k',transform=ax1.transAxes)
ax1.text(0.71*(left+right), 0.85*(bottom+top), 'Insulin - Glp1++',horizontalalignment='left',verticalalignment='center',fontsize=18,fontname="Arial",fontweight="normal",color='k',transform=ax1.transAxes)
...
fig.savefig("meta_normal_glp1.png", transparent=True,dpi=400)
