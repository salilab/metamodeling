...
print(k_prior_mu[999], k_prior_sigma[999])
print(k_posterior_mu[999], k_posterior_sigma[999])

k_prior = gaussian(x, k_prior_mu[999], k_prior_sigma[999])
k_posterior = gaussian(x, k_posterior_mu[999], k_posterior_sigma[999])

k_prior2 = gaussian(x, k_prior_mu2[999], k_prior_sigma2[999])
k_posterior2 = gaussian(x, k_posterior_mu2[999], k_posterior_sigma2[999])

#ax1.plot(x,k_prior,'red',linestyle="-",linewidth=2)
ax1.plot(x,k_posterior,'red',linestyle="-",linewidth=2)

#ax1.plot((k_prior_mu[999],k_prior_mu[999]),(0,max(k_prior)),'red',linestyle=":",linewidth=1)
ax1.plot((k_posterior_mu[999],k_posterior_mu[999]),(0,max(k_posterior)),'red',linestyle=":",linewidth=1)

#ax1.plot(x,k_prior2,'green',linestyle="-",linewidth=2)
#ax1.plot(x,k_posterior2,'r',linestyle="-",linewidth=2)

#ax1.plot((k_prior_mu2[999],k_prior_mu2[999]),(0,max(k_prior2)),'green',linestyle=":",linewidth=1)
#ax1.plot((k_posterior_mu2[999],k_posterior_mu2[999]),(0,max(k_posterior2)),'r',linestyle=":",linewidth=1)
...
#ax1.text(0.82*(left+right), 0.95*(bottom+top), 'k.SPT',horizontalalignment='left',verticalalignment='center',fontsize=18,fontname="Arial",fontweight="normal",color='k',transform=ax1.transAxes)
